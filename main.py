...
@click.option("-l", "--label", help="name of output directory (default '2-size-6K')", default="2-size-6K")
@click.option("-c", "--count", help="amount of generated items (default 6000)", default=6000)
