...
class BasicCommunication(BaseData):
    ...
    NEUTRAL_SENTENCES = [
        ...
        "I accidentally missed my last appointment. Can I reschedule it?",
        "What's the best way to care for my new dental crown?",
        "Do you offer teeth whitening services, and what are the costs?",
        "Can you provide information on pediatric dental care?",
        "Is there a waiting list for new patient appointments?",
        "What's the policy on cancellations or no-shows?",
        "Are there any dietary restrictions after a tooth extraction?",
        "Can I request a copy of my treatment plan?",
        "Do you have any recommendations for managing dental anxiety?",
        "How often should I replace my toothbrush?",
        "Hello, I'd like to schedule a regular cleaning service for my home. Can you provide availability?",
        "What types of cleaning packages do you offer, and what are the rates?",
        "Is there a minimum contract period for your services?",
        "Do you use eco-friendly cleaning products?",
        "Can you clean specific areas like carpets, upholstery, or windows?",
        "How do you handle special requests, such as deep cleaning or organizing?",
        "What safety protocols do your cleaners follow during the pandemic?",
        "Are your employees insured and background-checked?",
        "Can you provide references from other satisfied clients?",
        "What's the best way to contact you for booking or inquiries?",
        "Is there a cancellation policy if I need to reschedule my cleaning appointment?",
        "What's the estimated duration for a standard cleaning session?",
        "Do you offer any discounts for recurring clients?",
        "Can you accommodate specific time slots, such as early mornings or weekends?",
        "How do you handle delicate or valuable items during cleaning?",
        "What's the process for reporting any issues or concerns after a cleaning service?",
        "Are there any additional charges for cleaning supplies or equipment?",
